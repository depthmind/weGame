	...
	<section>
        ...
        <div class="panel-body panel-body-nopadding">
          	...
          	<div class="section-block">
	            ...
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">密码<span class="asterisk">*</span></label>
	              <div class="col-sm-8">
	                <input type="password" name="pwd" placeholder="密码" class="form-control" />
	              </div>
	            </div>
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">重复密码<span class="asterisk">*</span></label>
	              <div class="col-sm-8">
	            ...
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">邮箱<span class="asterisk">*</span></label>
	              <div class="col-sm-8">
	            ...
	            <div class="form-group col-sm-4">
                 ...
                 <div class="form-group col-sm-4">
	              ...
	              <div class="col-sm-8">
	               <input name="serviceType" class="userService-select fullwidth" >
	              </div>
	            </div>  
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">云呼账号</label>
	              <div class="col-sm-8">
	                <input type="text" name="cccAccount" placeholder="云呼账号" class="form-control" />
	              </div>
	            </div> 
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">云呼密码</label>
	              <div class="col-sm-8">
	                <input type="text" name="cccPassword" placeholder="云呼密码" class="form-control" />
	              </div>
	            </div>     
	        </div>
        </div><!-- panel-body -->
