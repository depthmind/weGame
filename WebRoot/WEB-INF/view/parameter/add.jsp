	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="glyphicon glyphicon-cog"></i> 系统管理 <span>新增系统参数</span>
				</h2>
			</div>
        ...
        <div class="panel-body panel-body-nopadding">
	        ...
	        <div class="section-block">    
	            <div class="form-group col-sm-4">
	              ...
	              <div class="col-sm-8">
	                <input type="text" id="domain" name="domain" placeholder="系统参数名(少于32字符)" class="form-control" />
	              </div>
	            </div>
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">值 <span class="asterisk">*</span></label>
	              <div class="col-sm-8">
	                <input type="text" id="value" name="value" placeholder="值（少于512字符）" class="form-control" />
	              </div>
	            </div> 			
	            <div class="form-group col-sm-4">
