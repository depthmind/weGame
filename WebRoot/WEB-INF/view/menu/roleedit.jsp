	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-key"></i> 权限管理 <span>编辑角色</span>
				</h2>
			</div>
	           ...
	           <div class="form-group col-sm-6">
	            ...
	            <div> --%>
	           	...
	           	<%-- <div class="container">
					...
					<%-- <div class="row">
						<h4 class="col-md-12" style="margin-top: 20px; color: #000;">供应商栏列表</h4>
						<div class="col-md-2">
							<div class="ckbox ckbox-primary">
					...
					<%-- <div class="row">
                        <h4 class="col-md-12" style="margin-top: 20px; color: #000;">客户栏列表</h4>
                        <div class="col-md-2">
                            <div class="ckbox ckbox-primary">
                          ...
                          <c:forEach items="${menu}" var="menu">
                            <c:if test="${menu.menuCategory eq 'enterprisemenu'}">
                                <div class="col-md-2">
                                    <div class="ckbox ckbox-primary">
                                        <input id="${menu.menuID}" class="check" name="enterprisemenu" type="checkbox" value="${menu.menuID}"/>
                                        <label for="${menu.menuID}">${menu.menuName}</label> 
                                    </div>
                                </div>
                            </c:if>
					...
					<!-- <div class="row">
					<h4 class="col-md-12" style="margin-top: 20px; color: #000;">该权限下用户信息</h4>
...
<div class="modal fade" id="msgModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	...
	jQuery(document).ready(function() {
		...
		//用户列表
		/* var t = jQuery('#dataTable-user').DataTable({
			searching:false,
			processing: true,
			paging: false,
			...
			bInfo : false,
			ajax: {
				url: '${rootPath}menu/queryUserById.do?id='+id,
		...
		$('#dataTable-user tbody').on( 'click', 'a.btn-success', function () {
